...
namespace WiGetMSModelsLibrary
{
    ...
    partial void OnoperatorChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="ApplicationDatasource_ApplicationUnits", Storage="_ApplicationUnits", ThisKey="id", OtherKey="datasourceid")]
		public EntitySet<ApplicationUnits> ApplicationUnits
		{
			get
			{
		...
		{
			this.SendPropertyChanging();
			entity.ApplicationDatasource = this;
		}
		
		private void detach_ApplicationUnits(ApplicationUnits entity)
		{
			this.SendPropertyChanging();
			entity.ApplicationDatasource = null;
		}
	}
	...
	public partial class ApplicationUnits : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntityRef<ApplicationDatasource> _ApplicationDatasource;
    ...
    partial void Onres2Changed();
		...
		public ApplicationUnits()
		{
			...
			this._ApplicationDatasource = default(EntityRef<ApplicationDatasource>);
		...
		public System.Nullable<int> datasourceid
		{
			...
			set
			{
				...
				{
					if (this._ApplicationDatasource.HasLoadedOrAssignedValue)
					{
						throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
					}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="ApplicationDatasource_ApplicationUnits", Storage="_ApplicationDatasource", ThisKey="datasourceid", OtherKey="id", IsForeignKey=true)]
		public ApplicationDatasource ApplicationDatasource
		{
			get
			{
				return this._ApplicationDatasource.Entity;
			}
			set
			{
				ApplicationDatasource previousValue = this._ApplicationDatasource.Entity;
				if (((previousValue != value) 
							|| (this._ApplicationDatasource.HasLoadedOrAssignedValue == false)))
				{
					this.SendPropertyChanging();
					if ((previousValue != null))
					{
						this._ApplicationDatasource.Entity = null;
						previousValue.ApplicationUnits.Remove(this);
					}
					this._ApplicationDatasource.Entity = value;
					if ((value != null))
					{
					...
					this.SendPropertyChanged("ApplicationDatasource");
				}
			}
		}
